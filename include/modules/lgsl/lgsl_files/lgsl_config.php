...
//[ ADVANCED SETTINGS - DO NOT TOUCH THESE UNLESS YOU KNOW WHAT YOUR DOING ]
  ...
  $lgsl_config['retry_offline'] = 1;           // 1=repeat query if a server does not respond the first time
  $lgsl_config['timeout']       = 1;           // 1=increase the time a server is given to respond
  $lgsl_config['live_time']     = 4;           // maximum loading delay from getting server updates
  $lgsl_config['cache_time']    = 15;          // seconds before the cached information is considered old
  $lgsl_config['url_path']      = "/include/modules/lgsl/lgsl_files/";          // full url to /lgsl_files/ for when auto detection fails
