...
/*--------------------------------------------------------------------------------------------*\
  ...
  This script provides generic form_validation for any web form. For a discussion and example usage 
...
/*--------------------------------------------------------------------------------------------*\
  ...
  Purpose:  generic form field form_validation.
  Parameters: field - the POST / GET fields from a form which need to be validated.
              rules - an array of the form_validation rules. Each rule is a string of the form:
  ...
  Comments:   With both digits_only, valid_email and is_alpha options, if the empty string is passed 
              in it won't generate an error, thus allowing form_validation of non-required fields. So,
              for example, if you want a field to be a valid email address, provide form_validation for 
...
{ 
  ...
  for ($i=0; $i<count($rules); $i++)
  {
    ...
    // depending on the form_validation test, store the incoming strings for use later...
