/*
htmLawed_README.txt, 14 August 2012
...
-- 2.8  Limitations & work-arounds ---------------------------------o
  ...
  It should be borne in mind that no browser application is 100% standard-compliant, and that some of the standard specifications (like asking for normalization of white-spacing within 'textarea' elements) are clearly wrong. Regarding security, note that `unsafe` HTML code is not necessarily legally invalid.
